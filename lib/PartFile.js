...
var PartFile = module.exports = function PartFile(torrent, blockSize) {
	...
	this._numPieces = Math.floor(this._length / this._pieceLength);
	this._numBlocks = Math.floor(this._pieceLength / blockSize);
...
peerface.connect('96.126.104.219', 59961).then(function(peer){
	...
	peer.on('piece', function (msg){
        //console.log('piece', JSON.stringify(msg));
